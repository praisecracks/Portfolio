...
function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center bg-white dark:bg-black pt-24"
    >
      <div className="max-w-screen-xl mx-auto w-full px-4 sm:px-6 lg:px-8 flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        {/* Left Content */}
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <h2 className="text-teal-500 text-lg sm:text-xl md:text-2xl font-semibold mb-4">
            <Typewriter
              options={{
                strings: ['Web Developer', 'React Enthusiast', 'Ruby Programmer', 'Graphics Designer'],
                autoStart: true,
                loop: true,
              }}
            />
