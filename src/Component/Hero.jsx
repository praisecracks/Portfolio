...
function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-20 py-16 gap-10 bg-white dark:bg-black transition duration-300 relative md:px-32"
    >
      {/* Text Section */}
